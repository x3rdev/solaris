...
public class BlockItemRegistry {
    ...
    public static final RegistryObject<BlockItem> SOLARIS_SUN = BLOCK_ITEMS.register("solaris_sun",
            () -> new BlockItem(BlockRegistry.SOLARIS_SUN.get(), new Item.Properties()));
}
