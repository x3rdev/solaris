...
public class FireKatanaItem extends SwordItem {
    ...
    public static void onKill(LivingDeathEvent event) {
        ...
        if(event.getSource().getDirectEntity() instanceof Projectile && event.getEntityLiving().isDeadOrDying() && entity instanceof LivingEntity livingEntity && livingEntity.getEffect(MobEffectRegistry.FIRE_RING.get()) != null) {
            ...
            for(Entity toHit : entity.level.getEntities(livingEntity, hitBox)) {
