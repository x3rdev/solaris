package com.github.x3rmination.solaris.common.item.HolyBlade;
...
public class HolyBladeItem extends SwordItem implements SolarisParticleWeapon {

    public HolyBladeItem(Properties pProperties) {
