...
public class WhitestoneArmorModel extends SolarisArmorModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(24, 0).mirror().addBox(-0.1F, 0.6F, 0.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 59).mirror().addBox(-0.5F, -0.4F, -0.75F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(49, 7).mirror().addBox(-0.5F, 1.6F, 0.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(50, 49).mirror().addBox(-0.5F, -0.4F, 1.25F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(48, 34).mirror().addBox(-0.5F, -0.4F, 0.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.2981F, -2.4633F, -5.202F, 0.1097F, -0.8003F, -0.0179F));
        ...
        PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(45, 0).addBox(-5.6F, 1.8F, -5.6F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(46, 10).addBox(-6.0F, 2.8F, -6.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -10.0F, -0.2F, 0.3622F, -0.7519F, -0.2533F));

        PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(48, 34).addBox(-0.5F, -0.4F, 0.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 0).addBox(-0.9F, 0.6F, 0.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(50, 49).addBox(-0.5F, -0.4F, 1.25F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(49, 7).addBox(-0.5F, 1.6F, 0.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 59).addBox(-0.5F, -0.4F, -0.75F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.2981F, -2.4633F, -5.202F, 0.1097F, 0.8003F, 0.0179F));

        PartDefinition cube_r4 = head.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 30).mirror().addBox(-0.5F, -2.2F, -0.2F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.2363F, -5.7216F, -4.3074F, 0.0224F, -0.8003F, -0.0179F));

        PartDefinition cube_r5 = head.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 30).addBox(-0.5F, -2.2F, -0.2F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.2363F, -5.7216F, -4.3074F, 0.0224F, 0.8003F, 0.0179F));
        ...
        PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(0, 43).mirror().addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.1F)).mirror(false)
        ...
        PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(0, 43).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.1F))
        ...
        PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(36, 32).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offset(-2.0F, 12.0F, 0.0F));
        ...
        PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(36, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offset(2.0F, 12.0F, 0.0F));
