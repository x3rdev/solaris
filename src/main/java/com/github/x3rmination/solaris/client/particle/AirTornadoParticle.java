...
public class AirTornadoParticle extends TextureSheetParticle {

    protected Vec3 deltaSpeed;
    public AirTornadoParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
    ...
    public static class Provider implements ParticleProvider<AirTornadoOption> {
        ...
        public Particle createParticle(AirTornadoOption pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            AirTornadoParticle particle = new AirTornadoParticle(pLevel, pX, pY + 0.075 * pType.getAge(), pZ, pXSpeed, pYSpeed, pZSpeed);
